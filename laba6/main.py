...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_fl = QPushButton(".", self)
        self.hbox_third.addWidget(self.b_fl)
        ...
        self.b_fl.clicked.connect(lambda: self._button("."))
    ...
    def error_message(self, error_type):
        ...
        if error_type == 'div_by_zero':
            msg = QMessageBox.question(self, 'error', 'Нельзя делить на 0', QMessageBox.Yes)
        elif error_type == 'input_error':
            msg = QMessageBox.question(self, 'error', 'Необходимо ввести число', QMessageBox.Yes)
        self.input.setText("")
